...
root = Tk()
root.geometry("541x580")
root.title("WOTM - What's On The Menu!")
root.configure(bg="#B8D8D8")
root.resizable(False, False)
btnimg1 = PhotoImage(file=r"C:\Users\Kelv\Dropbox\Programming\Python\Projects\Completed\WOTM - What's On The Menu!\UI\button_view-shopping-list.png")
btnimg2 = PhotoImage(file=r"C:\Users\Kelv\Dropbox\Programming\Python\Projects\Completed\WOTM - What's On The Menu!\UI\button_view-menu.png")
btnimg3 = PhotoImage(file=r"C:\Users\Kelv\Dropbox\Programming\Python\Projects\Completed\WOTM - What's On The Menu!\UI\button_open-scratchpad.png")
btnimg4 = PhotoImage(file=r"C:\Users\Kelv\Dropbox\Programming\Python\Projects\Completed\WOTM - What's On The Menu!\UI\button_save-scratchpad.png")
btnimg5 = PhotoImage(file=r"C:\Users\Kelv\Dropbox\Programming\Python\Projects\Completed\WOTM - What's On The Menu!\UI\button_generate-shopping.png")
btnimg6 = PhotoImage(file=r"C:\Users\Kelv\Dropbox\Programming\Python\Projects\Completed\WOTM - What's On The Menu!\UI\button_exit.png")
btnimg7 = PhotoImage(file=r"C:\Users\Kelv\Dropbox\Programming\Python\Projects\Completed\WOTM - What's On The Menu!\UI\button_ok.png")

kelv1 = [
        "Tesco White Bread Loaf\n",
        "Drink - Apple Juice\n",
        "Drink - Tropical Carton\n",
        "Drink - Blackcurrant Squash\n",
        "Cheddar Cheese\n",
        "Skinny Chips\n",
...
line1 = ["--- K E L V ---\n\n"]
line2 = ["--- T O I L E T R Y ---\n\n"]
line3 = ["--- E S S E N T I A L S ---\n\n"]
line4 = ["--- E M ---\n\n"]
line5 = ["--- B R E A K F A S T   M E N U ---\n\n"]
line6 = ["--- D I N N E R   M E N U ---\n\n"]
line7 = ["--- B A K I N G   M E N U ---\n\n"]

test = line1 + kelv1 + line2 + kelv2 + line3 + essentials + line4 + emma1 + emma2
menu = line5 + breakfast + line6 + dinner + line7 + baking

def window2():
    pop = Toplevel(root)
    pop.title("WOTM - What's On The Menu!")
    pop.geometry("350x150")
    pop.config(bg="#B8D8D8")
    Label(pop, text="", bg="#B8D8D8").grid(column=0, row=0, columnspan=3)
    Label(pop, text="Your shopping list has now been generated!\n", bg="#B8D8D8", justify="center").grid(column=1, row=0, columnspan=3)
...
def save_data():
    file = open("wotm_scratchpad.txt", "w")
...
sep1 = ttk.Separator().place(x=90, y=160, relwidth=0.1)
...
def BTN3():
    item = open(r"C:\Users\Kelv\Dropbox\Programming\Python\Completed\WOTM - What's On The Menu!\logs\wotm_scratchpad.txt", "r").read()
    textbox.configure(state="normal")
    textbox.delete("1.0", END)
...
sep2 = ttk.Separator().place(x=90, y=402, relwidth=0.1)
