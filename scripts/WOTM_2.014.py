...
user = os.getlogin()
#db = os.path.join(r"\\192.168.1.97\shared-snowmoon\scripts\db\wotm_goodikel.db")
db = os.path.join(r"\\192.168.1.97\shared-snowmoon\database\wotm_goodikel.db")
...
ui_view_meals = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_view_meals.png"
ui_view_items = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_view_items.png"
ui_generate_shopping = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_generate-shopping.png"
ui_exit = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_exit.png"
ui_back = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_back.png"
ui_add = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\UI\button_add.png"
ui_remove = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_remove.png"
ui_add_meal = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_add_meal.png"
ui_update_meal = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_update_meal.png"
ui_home = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_home.png"
ui_add_item = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_add_item.png"
ui_remove_item = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\WOTM - What's On The Menu!\\UI\button_remove_item.png"
