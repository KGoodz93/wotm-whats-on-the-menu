...
ui_generate_shopping = os.path.join(path, r'UI/button_generate_meals.png')
...
ui_remove_meal = os.path.join(path, r'UI/button_remove_meal.png')
...
ui_add_items = os.path.join(path, r'UI/button_add_items.png')
ui_delete_items = os.path.join(path, r'UI/button_delete_items.png')
ui_update_items = os.path.join(path, r'UI/button_update_items.png')
...
def window_main():
    ...
    btn1 = Button(command=mainmenu_viewmenu, image=mainmenu_btn1, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0, )
    btn1.grid(column=0, row=1, padx=80, pady=20)

    sep1 = ttk.Separator()
    sep1.place(x=118, y=82, relwidth=0.2)

    btn2 = Button(command=mainmenu_viewitems, image=mainmenu_btn2, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0, )
    btn2.grid(column=0, row=2, padx=80, pady=20)

    sep2 = ttk.Separator()
    sep2.place(x=118, y=164, relwidth=0.2)

    btn3 = Button(command=mainmenu_generateshopping, image=mainmenu_btn3, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0, )
    btn3.grid(column=0, row=4, padx=80, pady=20)

    sep3 = ttk.Separator()
    sep3.place(x=118, y=246, relwidth=0.2)

    btn4 = Button(command=root1.destroy, image=mainmenu_btn4, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0, )
...
def window_viewmeals():
    ...
    root2 = Tk()
    root2.geometry("720x420+100+100")
    ...
    viewmenu_btnimg1 = PhotoImage(file=ui_add_meal, master=root2)
    viewmenu_btnimg2 = PhotoImage(file=ui_remove_meal, master=root2)
    ...
    def window_addmeal():
        ...
        frame1 = Frame(root5, padx=5, pady=5, bg=bg_colour)
        frame1.grid(column=0, row=0, padx=45)

        frame2 = Frame(root5, padx=5, pady=5, bg=bg_colour)
        frame2.grid(column=0, row=1)

        frame3 = Frame(root5, padx=5, pady=5, bg=bg_colour)
        frame3.grid(column=0, row=2, padx=20)

        lbl1 = Label(frame1, text="Breakfast / Lunch / Dinner:", bg=bg_colour)
        lbl1.grid(column=0, row=0, pady=5)

        cbox1 = ttk.Combobox(frame1, value=meal_list, width=76)
        cbox1.grid(column=0, row=1)

        lbl2 = Label(frame1, text="Name:", bg=bg_colour)
        lbl2.grid(column=0, row=2, pady=5)

        ebox1 = Entry(frame1, width=79)
        ebox1.grid(column=0, row=3)

        lbl3 = Label(frame2, text="Quantity", bg=bg_colour)
        lbl3.grid(column=0, row=0, pady=5)

        lbl4 = Label(frame2, text="Item", bg=bg_colour)
        lbl4.grid(column=1, row=0, pady=5)

        lbl5 = Label(frame2, text="Price", bg=bg_colour)
        ...
        btn1 = Button(frame3, command=add, image=addmeal_btn1, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0, )
        btn1.grid(padx=10, column=0, row=0, pady=25)

        btn2 = Button(frame3, command=home, image=addmeal_btn2, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0, )
    ...
    def window_update_meal():
        ...
        def add():
            ...
            frame1 = Frame(root7, padx=40, pady=20, bg=bg_colour)
            frame1.grid(column=0, row=0)

            # Widgets - Frame 2

            frame2 = Frame(frame1, padx=5, pady=5, bg=bg_colour)
            frame2.grid(column=0, row=0)

            lbl1 = Label(frame2, text="Select Meal:", bg=bg_colour)
            lbl1.grid(column=0, row=0, pady=5)
            ...
            frame3 = Frame(frame1, padx=5, pady=5, bg=bg_colour)
            frame3.grid(column=0, row=1)

            lbl1 = Label(frame3, text="Quantity", bg=bg_colour)
            lbl1.grid(column=0, row=0, pady=5)

            lbl2 = Label(frame3, text="Item", bg=bg_colour)
            lbl2.grid(column=1, row=0, pady=5)

            lbl3 = Label(frame3, text="Price", bg=bg_colour)
        ...
        def upd():
            root9 = Tk()
            root9.geometry("575x360+100+100")
            root9.title("WOTM Meal Planner - Update Meal")
            root9.configure(bg=bg_colour)
            ...
            frame1 = Frame(root9, padx=40, pady=20, bg=bg_colour)
            frame1.grid(column=0, row=0)
            ...
            def search():
                if combo1.get() in newlist:
                    ...
                    lbl2 = Label(frame2, text="Select Item:", bg=bg_colour)
                    lbl2.grid(column=0, row=2, pady=5)
                    combo2 = ttk.Combobox(frame2, width=76, values=meal_items)
                    combo2.grid(column=0, row=3)
                    lbl2 = Label(frame2, text="Select Meal Type:", bg=bg_colour)
                    lbl2.grid(column=0, row=4, pady=5)
                    combo3 = ttk.Combobox(frame2, width=76, values=meal_type)
                    combo3.grid(column=0, row=5)

                def confirm():
                    cursor.execute('delete from mealitems where meal=(?) and item=(?)', (f'{combo1.get()}', f'{combo2.get()}',))
                    cursor.execute('INSERT INTO mealitems values(?,?,?,?,?,?)', (entry_quantity.get(), entry_item.get(), entry_price.get(), entry_price.get(), combo1.get(), combo3.get(),))
                    connection.commit()
                ...
                add_btn2 = Button(frame4, command=confirm, image=btnimg_add, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0)
                add_btn2.grid(padx=10, column=1, row=0, pady=25)
            ...
            lbl3 = Label(frame3, text="Quantity", bg=bg_colour)
            lbl3.grid(column=0, row=2, pady=5)

            lbl4 = Label(frame3, text="Item", bg=bg_colour)
            lbl4.grid(column=1, row=2, pady=5)

            lbl5 = Label(frame3, text="Price", bg=bg_colour)
            ...
            add_btn1 = Button(frame4, command=search, image=btnimg_search, borderwidth=0, highlightthickness=0,activebackground=bg_colour, bg=bg_colour, bd=0)
            add_btn1.grid(padx=10, column=0, row=0, pady=25)

            add_btn3 = Button(frame4, command=root9.destroy, image=btnimg_bac, borderwidth=0, highlightthickness=0,activebackground=bg_colour, bg=bg_colour, bd=0)
        ...
        def delete():
            ...
            frame1 = Frame(root8, padx=40, pady=20, bg=bg_colour)
            frame1.grid(column=0, row=0)
            ...
            def search():
                if combo1.get() in newlist:
                    ...
                    add_btn2 = Button(frame3, command=confirm, image=btnimg_add, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0)
                    add_btn2.grid(padx=10, column=1, row=0, pady=25)

            add_btn1 = Button(frame3, command=search, image=btnimg_search, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0)
            add_btn1.grid(padx=10, column=0, row=0, pady=25)

            add_btn3 = Button(frame3, command=root8.destroy, image=btnimg_bac, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0)
            add_btn3.grid(padx=10, column=2, row=0, pady=25)
        ...
        btnimg_add = PhotoImage(file=ui_add_items, master=root6)
        btnimg_upd = PhotoImage(file=ui_update_items, master=root6)
        btnimg_del = PhotoImage(file=ui_delete_items, master=root6)
        btnimg_bac = PhotoImage(file=ui_back, master=root6)

        # Widgets - Frame 1

        frame1 = Frame(root6, padx=40, pady=20, bg=bg_colour)
        frame1.grid(column=0, row=0)

        btn1 = Button(frame1, command=add, image=btnimg_add, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0)
        btn1.grid(padx=10, column=0, row=0, pady=25)

        btn2 = Button(frame1, command=upd, image=btnimg_upd, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0)
        btn2.grid(padx=10, column=0, row=1, pady=25)

        btn3 = Button(frame1, command=delete, image=btnimg_del, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0)
        btn3.grid(padx=10, column=0, row=2, pady=25)

        btn4 = Button(frame1, command=root6.destroy, image=btnimg_bac, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0)
    ...
    frame1 = Frame(root2, padx=5, pady=5, bg=bg_colour)
    frame1.pack(padx=10, pady=30)

    frame2 = Frame(root2, padx=5, pady=5, bg=bg_colour)
    frame2.pack()
    ...
    btn1 = Button(frame2, command=add_meal, image=viewmenu_btnimg1, borderwidth=0, highlightthickness=0, activebackground="#B8D8D8", bg=bg_colour, bd=0)
    btn1.grid(column=0, row=1, padx=15)

    btn2 = Button(frame2, command=remove_meal, image=viewmenu_btnimg2, borderwidth=0, highlightthickness=0, activebackground="#B8D8D8", bg=bg_colour, bd=0)
    btn2.grid(column=1, row=1, padx=15)

    btn3 = Button(frame2, command=window_update_meal, image=viewmenu_btnimg3, borderwidth=0, highlightthickness=0, activebackground="#B8D8D8", bg=bg_colour, bd=0)
    btn3.grid(column=2, row=1, padx=15)

    btn4 = Button(frame2, command=home, image=viewmenu_btnimg4, borderwidth=0, highlightthickness=0, activebackground="#B8D8D8", bg=bg_colour, bd=0)
...
def window_viewitems():
    ...
    frame3 = Frame(root3, bg=bg_colour)
    frame3.pack(pady=20)

    frame1 = Frame(root3, padx=5, bg=bg_colour)
    frame1.pack(pady=5)

    frame2 = Frame(root3, padx=5, pady=5, bg=bg_colour)
    frame2.pack(pady=30)

    btn1 = Button(frame2, command=add_item, image=viewitems_btn1, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0, )
    btn1.grid(padx=10, column=0, row=3)

    btn2 = Button(frame2, command=remove_item, image=viewitems_btn2, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0, )
    btn2.grid(padx=10, column=1, row=3)

    btn3 = Button(frame2, command=home, image=viewitems_btn3, borderwidth=0, highlightthickness=0, activebackground=bg_colour, bg=bg_colour, bd=0, )
    btn3.grid(padx=10, column=2, row=3)

    label1 = Label(frame3, text="Quantity", bg=bg_colour)
    label1.grid(pady=5, column=0, row=0)

    label2 = Label(frame3, text="Item(s)", bg=bg_colour)
    label2.grid(pady=5, column=1, row=0)

    label3 = Label(frame3, text="Price", bg=bg_colour)
...
def window_generateshopping():
    ...
    root4.configure(bg=bg_colour)
    root4.resizable(False, False)

    # Widgets

    frame1 = Frame(root4, padx=5, pady=5, bg=bg_colour)
    frame1.grid(column=1, row=0, pady=25)

    frame2 = Frame(root4, padx=5, pady=5, bg=bg_colour)
    frame2.grid(column=0, row=1, columnspan=3, padx=1, pady=2)

    frame3 = Frame(root4, padx=5, pady=5, bg=bg_colour)
    ...
    def meal_data():
        ...
        cursor.execute("SELECT meal FROM mealitems WHERE meal_type=(?) ORDER BY RANDOM() LIMIT 5", ('Breakfast',))
        result1 = cursor.fetchall()

        cursor.execute("SELECT meal FROM mealitems WHERE meal_type=(?) ORDER BY RANDOM() LIMIT 5", ('Dinner',))
        result2 = cursor.fetchall()

        cursor.execute(f'''INSERT INTO _sorted SELECT quantity, item, printf('%.2f', price) as price, printf('%.2f', r_price) as r_price FROM mealitems where meal="{result1[0][0]}"''')
        cursor.execute(f'''INSERT INTO _sorted SELECT quantity, item, printf('%.2f', price) as price, printf('%.2f', r_price) as r_price FROM mealitems where meal="{result1[1][0]}"''')
        cursor.execute(f'''INSERT INTO _sorted SELECT quantity, item, printf('%.2f', price) as price, printf('%.2f', r_price) as r_price FROM mealitems where meal="{result1[2][0]}"''')
        cursor.execute(f'''INSERT INTO _sorted SELECT quantity, item, printf('%.2f', price) as price, printf('%.2f', r_price) as r_price FROM mealitems where meal="{result1[3][0]}"''')
        cursor.execute(f'''INSERT INTO _sorted SELECT quantity, item, printf('%.2f', price) as price, printf('%.2f', r_price) as r_price FROM mealitems where meal="{result1[4][0]}"''')

        cursor.execute(f'''INSERT INTO _sorted SELECT quantity, item, printf('%.2f', price) as price, printf('%.2f', r_price) as r_price FROM mealitems where meal="{result2[0][0]}"''')
        cursor.execute(f'''INSERT INTO _sorted SELECT quantity, item, printf('%.2f', price) as price, printf('%.2f', r_price) as r_price FROM mealitems where meal="{result2[1][0]}"''')
        cursor.execute(f'''INSERT INTO _sorted SELECT quantity, item, printf('%.2f', price) as price, printf('%.2f', r_price) as r_price FROM mealitems where meal="{result2[2][0]}"''')
        cursor.execute(f'''INSERT INTO _sorted SELECT quantity, item, printf('%.2f', price) as price, printf('%.2f', r_price) as r_price FROM mealitems where meal="{result2[3][0]}"''')
        cursor.execute(f'''INSERT INTO _sorted SELECT quantity, item, printf('%.2f', price) as price, printf('%.2f', r_price) as r_price FROM mealitems where meal="{result2[4][0]}"''')

        connection.commit()

        # Labels

        Label(frame3, bg="#FFFFFF", width=40, height=4, text=f"{result1[0][0]}\n\n{result2[0][0]}").grid(column=0, row=0, pady=7, padx=35)
        Label(frame3, bg="#FFFFFF", width=40, height=4, text=f"{result1[1][0]}\n\n{result2[1][0]}").grid(column=0, row=1, pady=7, padx=35)
        Label(frame3, bg="#FFFFFF", width=40, height=4, text=f"{result1[2][0]}\n\n{result2[2][0]}").grid(column=0, row=2, pady=7, padx=35)
        Label(frame3, bg="#FFFFFF", width=40, height=4, text=f"{result1[3][0]}\n\n{result2[3][0]}").grid(column=0, row=3, pady=7, padx=35)
        Label(frame3, bg="#FFFFFF", width=40, height=4, text=f"{result1[4][0]}\n\n{result2[4][0]}").grid(column=0, row=4, pady=7, padx=35)
    ...
    def generate():
        ...
        def file_meals():
            return (str(f"Meal 1: {result1[0][0]}\n"
                        f"Meal 2: {result2[1][0]}\n"
                        f"Meal 3: {result3[2][0]}\n"
                        f"Meal 4: {result4[3][0]}\n"
                        f"Meal 5: {result5[4][0]}"))
    ...
    btn1 = Button(frame2, command=quant_increase, image=generateshopping_btn1, borderwidth=0, highlightthickness=0, activebackground="#B8D8D8", bg=bg_colour, bd=0)
    ...
    btn2 = Button(frame2, command=quant_decrease, image=generateshopping_btn2, borderwidth=0, highlightthickness=0,
                  activebackground="#B8D8D8", bg=bg_colour, bd=0)
